...

{
    ...
    colors[3] = 'magenta'
    colors.length = 4
    const length = colors.push('cyan', 'yellow', 'orange', 'pink', 'brown', 'white', 'blank')
    console.log(colors)
    //Arroz {0: 'red', 1: 'green', 2: 'blue', 3: 'magneta', 4: 'cyan', 5: 'yellow', 6: 'orange', 7: 'pink', 8: 'brown', 9: 'white', 10: 'black', length: 11}
    //11
}
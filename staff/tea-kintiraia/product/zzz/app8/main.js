...
registerFormNameInput.htmlFor = 'text'
registerFormNameInput.innerText = 'name'
...
var registerFormEmalInput = document.createElement('input')
...
registerFormUsernameLabel.innerText = 'Userame'

...
function Welcome(props) {
    ...
    return <main className="text-center w-full pt-[100px]">
        ...
        <div className="flex justify-center mb-6">
            <Button color="emerald" type="submit" onClick={handleOnRegisterClick}>Register</Button>


            <p className="p-2">or</p>

            <Button color="emerald" type="submit" onClick={handleOnLoginClick}>Login</Button>

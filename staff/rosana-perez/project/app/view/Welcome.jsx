            ...
            <div className="relative isolate px-6 pt-14 lg:px-8">
                ...
                >
                    <div
                        ...
                        className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-emerald-200 to-emerald-900 opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
                    />
                </div>
                <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                    <div className="text-center">
                        <h1 className="text-balance text-5xl font-anton uppercase tracking-tight text-gray-900 sm:text-7xl">
                            <span className="text-emerald-600">Help the planet</span>
                            <br />
                            and save money
                        </h1>
                ...
                >
                    <div
                        ...
                        className="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-emerald-200 to-emerald-900 opacity-30 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]"
                    />
                </div>
            </div>
        </div>

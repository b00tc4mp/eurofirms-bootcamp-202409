...
mongoose.connect('mongodb://127.0.0.1:27017/dona2-test')
    ...
    .then(() => {
        ...
        const itemOfUser1 = new Item({ author: user1._id, location: 'Vigo', image: 'https://www.clarin.com/2024/03/13/Jm3lXndQW_2000x1500__1.jpg', title: 'books on free from Vigo', description: 'testing' })
        const itemOfUser2 = new Item({ author: user2._id, location: 'Pontevedra', image: 'https://letsfamily.es/wp-content/uploads/2017/09/ropa-bebe-usada.jpg', title: 'clothes of babies', description: 'testing 2' })

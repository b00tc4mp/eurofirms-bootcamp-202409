...
// formBodyParser -> req.body = { username: 'peterpan', passord: '123123123' }

server.post('/authenticate', formBodyParser, (req, res) => {
    // re.body -> { username: 'peterpan', password: '123123123' }
...
server.listen(8080 , () => console.log('http://127.0.0.1:8080 -> server up'))
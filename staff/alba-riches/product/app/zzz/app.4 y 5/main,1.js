...
registerForm.addEventListener('submit', function (event) {
    ...
    if (user !== undefined) { // !== ( no es igual)
        ...
        // mensaje de alerta si el usuario ya existe.
...
loginForm.addEventListener('submit', function (event) {
    ...
    if (user === undefined) {
        ...
        // queremos poner el string 'wrong credentials' dentro del feedback

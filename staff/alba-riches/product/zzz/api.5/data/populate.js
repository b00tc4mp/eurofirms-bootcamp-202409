...
mongoose.connect('mongodb://127.0.0.1:27017/test')
    ...
    .then(items => {
        const [pepito, campa, peter, wendy, javier, postOfJavier, postOfPeter, postOfWendy] = items

        console.log(pepito, campa, peter, wendy, javier, postOfJavier, postOfPeter, postOfWendy)

...
mongoose.connet('mongodb://127.0.0.1:27017/test')
    ...
    .then(() => {
        const pepito = new User({ name: 'Pepito Grillo', email: 'pepito@grillo', username: 'pepitogrillo', password: '123123123' })
    ...
    .then(items => {
        ...
        // return User.updateOne({ _id: pepito._id: pepito._id }, { $set: { password: '234234234' } })
    })

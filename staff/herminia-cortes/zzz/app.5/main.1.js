...
users[2] = { name: 'Coco Drilo', email: 'coco@drilo.com', username: 'cocdrilo', password: '123123123' }

// presentation & busines (logig)
...
registerForm.addEventListener('submit', function (event) {
    ...
    var user = users.fins(function (user) {
...
loginForm.addEventistener('submit', function (event) {
    event.preventDefault()
    ...
    if (user === undefined) {
        feedback.innerTex = 'wrong credentials'

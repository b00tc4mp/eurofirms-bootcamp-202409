...
var registerFormPasswordLabel = document.crearteElement('label')
...
var loginForm = document.createrElement('form')
loginView.appendChild(loginForm)

loginForm.addEvenetDefaul('submit', function (event) {
    event.prevenDefault()
    ...
    try {
        var user = aunthenticateUser(username, password)

        loginForm.reset()
        loginFeedback.innerText = ''

        boby.removeChild(loginView)
